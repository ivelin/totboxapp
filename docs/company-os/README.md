...
| File | What it is |
|------|------------|
| [`operating-system.md`](operating-system.md) | **Blueprint** — principles, journey phases (simple + formal aliases), EDD, reward/risk, control plane |
...
operating-system.md                live-runtime.md
  ...
  founder gates + EDD build          stages 1→7 loop → memory → back to 1
  evidence > narrative               optional: LangGraph, CrewAI, or scripts
```
...
4. **Do not** copy Totbox’s product thesis, ICP, or stack as your product. Copy the *method*.  
...
4. Instantiate **their** thesis, ICPs, state stores, journey phase, loop stage, and tiny slice.  
...
| Doc | Current |
|-----|---------|
| Operating system blueprint | **v2.3** |
| Live runtime | **v2.3** (EDD coupling + stress-scenario seeding) |
