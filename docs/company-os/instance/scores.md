...
|---|----------|------|----------------|
| 1 | **Less hassle?** | Clearly fewer human back-and-forths than Gmail/memory alone | Same or more hassle |
...
**Phase 1 business exit:** still **open** until several fair cleaning (then optional HVAC) jobs show pass signals and a redacted stage-6 note exists.
